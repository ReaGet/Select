...
export function initMarkup(context, options) {
  ...
  if (!wrapper.querySelector("[data-option='current'] [data-icon]")) {
    wrapper.querySelector("[data-option='current']").insertAdjacentHTML("beforeEnd", `
